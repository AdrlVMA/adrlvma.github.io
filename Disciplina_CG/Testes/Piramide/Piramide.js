...
aux = 0;
function define_eixo(){

    if (aux == 0){
        mat4.rotate(mMatrix, mMatrix, degToRad(rPiramide), [1, 0, 0]);   // Aplica rotação
        aux++;
    }
    ...
    if (aux == 2){
        mat4.rotate(mMatrix, mMatrix, degToRad(rPiramide), [0, 0, 1]);   // Aplica rotação
        aux = 0;
    }
